...
export default function Home() {
  return (
    <div className="relative w-full overflow-x-hidden bg-[#171A34]">
      <header className="fixed top-0 left-0 w-full z-[99] flex justify-between items-center pl-[20px] sm:pl-6 h-[60px] sm:h-[55px] text-white bg-[#fff] bg-opacity-25 backdrop-blur-md">
